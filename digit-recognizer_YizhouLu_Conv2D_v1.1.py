...
train_X = Conv2D(128,kernel_size=(3,3),padding='same',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv5')(train_X)
train_X = BatchNormalization(axis=-1, name='bn5')(train_X)
train_X = Dropout(0.5)(train_X)
train_X = Activation('relu')(train_X)

train_X = Conv2D(256,kernel_size=(3,3),padding='same',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv6')(train_X)
train_X = BatchNormalization(axis=-1, name='bn6')(train_X)

train_X_shortcut_3 = Conv2D(256,kernel_size=(1,1),strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv3_sc')(train_X_shortcut_3)
...
train_X_shortcut_4 = train_X

train_X = Conv2D(384,kernel_size=(3,3),padding='same',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv7')(train_X)
train_X = BatchNormalization(axis=-1, name='bn7')(train_X)
train_X = Dropout(0.5)(train_X)
train_X = Activation('relu')(train_X)

train_X = Conv2D(512,kernel_size=(3,3),padding='same',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv8')(train_X)
train_X = BatchNormalization(axis=-1, name='bn8')(train_X)

train_X_shortcut_4 = Conv2D(512,kernel_size=(1,1),strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv4_sc')(train_X_shortcut_4)
train_X_shortcut_4 = BatchNormalization(axis=-1,name='bn4_sc')(train_X_shortcut_4)

train_X = Add()([train_X, train_X_shortcut_4])
train_X = Dropout(0.5)(train_X)
train_X = Activation('relu')(train_X)

train_X = MaxPooling2D(pool_size=(2,2),strides=(2,2))(train_X)

train_X_shortcut_5 = train_X

train_X = Conv2D(768,kernel_size=(3,3),padding='valid',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv9')(train_X)
train_X = BatchNormalization(axis=-1, name='bn9')(train_X)
train_X = Dropout(0.5)(train_X)
train_X = Activation('relu')(train_X)

train_X = Conv2D(1024,kernel_size=(3,3),padding='valid',strides=(1,1),kernel_initializer=glorot_normal(seed=0),name='conv10')(train_X)
train_X = BatchNormalization(axis=-1, name='bn10')(train_X)

train_X_shortcut_5 = Conv2D(1024,kernel_size=(1,1),strides=(3,3),kernel_initializer=glorot_normal(seed=0),name='conv5_sc')(train_X_shortcut_5)
train_X_shortcut_5 = BatchNormalization(axis=-1,name='bn5_sc')(train_X_shortcut_5)

train_X = Add()([train_X, train_X_shortcut_5])
train_X = Dropout(0.5)(train_X)
train_X = Activation('relu')(train_X)
...
adam_lr_decay = Adam(lr=0.001, beta_1=0.75, beta_2=0.999, epsilon=1e-8, decay=3e-5)
prediction_model.compile(optimizer=adam_lr_decay,loss='categorical_crossentropy',metrics=['accuracy'])

prediction_model.fit(x=train_X_raw, y=train_y, batch_size=21, epochs=30, validation_split=0.0)
